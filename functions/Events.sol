...
contract Events {
    ...
    function EmitirEvento1(string calldata _personName) public {
        emit Event_one(_personName);
    }
    
    function EmitirEvento2(string calldata _personName, uint _age) public {
        emit Event_two(_personName, _age);
    }
    
    function EmitirEvento3(string calldata _personName, uint _age) public {
